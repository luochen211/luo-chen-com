...
const requiredSections = {
  zh: {
    ...
    article: { readingTime: '分钟阅读', previous: '上一篇', next: '下一篇', related: '继续读', unavailable: '文章暂时无法读取', loading: '加载中', pagerLabel: '同系列上一篇和下一篇', series: '同系列文章' },
  ...
  en: {
    ...
    article: { readingTime: 'min read', previous: 'Previous', next: 'Next', related: 'Keep reading', unavailable: 'This article is currently unavailable', loading: 'Loading', pagerLabel: 'Previous and next articles in this series', series: 'More in this series' },
