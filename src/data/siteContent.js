...
const localizedContent = {
  en: {
    ...
    hero: {
      ...
      intro:
        'I build Agent tooling and production systems, turning fuzzy requirements into boundaries, verification, and shipped results people can inspect.',
    ...
    course: {
      ...
      archive: {
        ...
        description:
          'Browse my public talk decks, or learn about AI Project Lab: a structured community for completing a first runnable, presentable, and deliverable AI project.',
        action: 'Open PPT Archive',
        href: '/slides/',
        communityAction: 'Explore AI Project Lab',
        communityHref: 'https://my.feishu.cn/docx/XKuRdcy3MoxS9ixBaa1cPzTYnVp',
      },
  ...
  zh: {
    ...
    hero: {
      ...
      intro:
        '我做 Agent 工具链，也做真实业务系统：把模糊需求拆成边界、验证和可上线的结果，让代码、产品与交付经得起检查。',
      manifestoLabel: '行动原则',
      manifesto:
    ...
    course: {
      ...
      archive: {
        title: '分享与社群',
        description: '这里整理我的直播、线下分享和 AI 产品演讲，也开放 AI接单实验室，陪你用 AI 完成第一个能运行、能展示、能交付的真实项目。',
        action: '打开 PPT 归档',
        href: '/slides/',
        communityAction: '了解 AI接单实验室',
        communityHref: 'https://my.feishu.cn/docx/XKuRdcy3MoxS9ixBaa1cPzTYnVp',
      },
      articlesTitle: '最新文章',
      topicsTitle: '专题',
