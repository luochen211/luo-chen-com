...
const copy = {
  zh: {
    ...
    harnessDemo: { name: 'Agent Harness 讲师演示台', role: '课程演示 · 产品与开发', status: '可在线演示', summary: '配合 37 页 Agent 与 Harness 基础课，用同一个购物助手把 Context、Tool、Recovery、Memory、Router 与 Evaluation 变成现场可见的系统行为。', outcome: '六个可控演示分别证明回答与完成、运行轨迹、故障恢复、信息归属、能力路由和任务分布评测。', details: ['演示台只服务讲师控制节奏，每个实验都有唯一证明目标、观察点与一句话落点。', '本地确定性 Harness 无需 API Key，可稳定复现追问、工具超时、有限重试、安全转交和六类边界测试。'] },
  ...
  en: {
    ...
    harnessDemo: { name: 'Agent Harness Presenter Console', role: 'Course demo · Product and engineering', status: 'Live demo', summary: 'A presenter-controlled companion to a 37-slide Agent Harness course, using one shopping assistant to make context, tools, recovery, memory, routing, and evaluation observable.', outcome: 'Six controlled demonstrations cover answer versus completion, execution traces, failure recovery, information ownership, capability routing, and task-distribution evaluation.', details: ['Each demo has one proof target, three audience cues, and one closing takeaway.', 'The deterministic local harness needs no API key and reliably reproduces clarification, timeouts, bounded retries, safe handoff, and boundary tests.'] },
