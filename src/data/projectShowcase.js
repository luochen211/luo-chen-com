...
const copy = {
  zh: {
    ...
    harnessDemo: { name: 'Agent Harness 讲师演示台', role: '课程演示 · 产品与开发', status: '可在线演示', summary: '配合 5 节、42 页 Agent 与 Harness 基础课，把 Context、Tool、Correction、Memory、能力发现与 Evaluation 变成现场可见的系统行为。', outcome: '演示内容围绕组成、运行、可靠性、信息分层、能力发现与过程/结果双重评测展开，并与课程页面逐项对应。', details: ['演示台只服务讲师控制节奏，每个实验都有唯一证明目标、观察点与一句话落点。', '本地确定性 Harness 无需 API Key，可稳定复现工具反馈、超时重试、恢复阶梯、信息归属和评测集检查。'] },
  ...
  en: {
    ...
    harnessDemo: { name: 'Agent Harness Presenter Console', role: 'Course demo · Product and engineering', status: 'Live demo', summary: 'A presenter-controlled companion to a five-lesson, 42-slide Agent Harness course that makes context, tools, correction, memory, capability discovery, and evaluation observable.', outcome: 'The demonstrations align composition, runtime, reliability, information layers, capability discovery, and process/outcome evaluation with the course.', details: ['Each demo has one proof target, three audience cues, and one closing takeaway.', 'The deterministic local harness needs no API key and reliably reproduces tool feedback, bounded retries, recovery ladders, information ownership, and evaluation-dataset checks.'] },
